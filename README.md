...
> **zzcollab blog post** | A complete guide to publishing technical documentation with reproducibility built-in

## Overview

A comprehensive blog post explaining how to convert standalone markdown documentation into a fully-featured, reproducible blog post using ZZCOLLAB and Quarto. Includes:

- Complete step-by-step workflow (40 minutes total)
...
This post was created by converting the `markdown_to_blogpost.md` process documentation into a blog post—demonstrating the very workflow it teaches!
...
The complete process documentation is available at:
```
~/prj/r05/LLMs-from-scratch/ch02/markdown_to_blogpost.md
```

This markdown file contains:
- 14 detailed parts with step-by-step instructions
...
```bash
git clone https://github.com/rgt47/markdowntoblog.git
cd markdowntoblog
zzcollab -u
make docker-zsh
